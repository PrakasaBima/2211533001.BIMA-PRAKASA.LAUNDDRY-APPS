...
import com.example.apaloundry.adapter.AdapterPelanggan;
    ...
    private View.OnClickListener onClickListener = new
            View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(com.example.apaloundry.pelanggan.PelangganActivity.this,PelangganEditActivity.class);
